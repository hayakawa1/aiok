        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mt-4">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>支払いが完了するまで、作品の利用権は発生しません。</li>
                <li>依頼者は、作品の完成に必要な情報を提供する以外に、クリエイターの作業方法や時間帯を指定することはできません。クリエイターは、自己の裁量で作業を進めることができます。</li>
              </ul>
            </section>
            <section>
              <h2 className="text-xl font-semibold mb-4">第4条（作品の利用）</h2>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>著作権はクリエイターに帰属します。ただし、依頼者は個人的鑑賞の範囲内で当該作品を利用できる権利を有します。</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                ...
                <li>以下のコンテンツの投稿を禁止します：</li>
                <li>・わいせつな表現や性的な描写を含むコンテンツ</li>
                <li>・児童ポルノまたは児童を性的に描写するコンテンツ</li>
                <li>・暴力的、差別的、公序良俗に反するコンテンツ</li>
                <li>二次創作については、原作の権利者が定めるガイドラインを厳守してください。権利者が二次創作を明確に禁止している場合は、制作を行わないでください。</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                ...
                <li>依頼者は、納品物を確認し、依頼内容と品質が合致していると判断した場合に報酬を支払うものとします。</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>運営会社は、利用者間で行われる取引の内容や結果について一切の責任を負いません。作品の品質や法的な適合性については、クリエイターが確認し、依頼者が合意するものとします。</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                ...
                <li>本規約及び本サービスに関連して紛争が生じた場合、訴額に応じて東京簡易裁判所または東京地方裁判所を第一審の専属的合意管轄裁判所とします。</li>
              </ul>
            </section>
            <section>
