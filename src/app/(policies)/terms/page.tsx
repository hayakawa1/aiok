        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mt-4">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>依頼者が作品制作の依頼（申込み）をし、クリエイターがこれを承諾した時点で契約が成立します。</li>
                <li>報酬の支払いは契約上の債務履行の要件となります。支払いが完了するまで、作品の利用権は発生しません。</li>
                <li>契約成立後、クリエイターは一方的に契約を解除することはできません。</li>
                <li>クレジットカード決済エラー等の技術的な理由により支払いが完了しない場合、依頼者は速やかに代替の支払い手段を用いて支払いを完了させるものとします。</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>著作権はクリエイターに帰属します。ただし、依頼者は個人的鑑賞の範囲内で当該作品を利用できる権利を有します。著作権の移転や追加の利用条件については、依頼者とクリエイターが別途合意した場合に限り有効となります。</li>
                <li>クリエイターは、作品の制作にあたり、第三者の権利を侵害しないよう適切な許諾を得る責任を負います。万一、第三者から権利侵害の申立てがあった場合、クリエイターが自己の責任と費用で解決するものとします。</li>
                <li>二次創作作品の制作については、クリエイターは原作の権利者から書面による許諾を得る義務を負います。権利者がガイドラインを定めていない場合や二次創作を明確に禁止している場合は、制作を行うことはできません。</li>
                <li>二次創作作品の商用利用は禁止です。また、原作の権利者が定める利用条件に従うものとします。</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                ...
                <li>二次創作については、原作の権利者が定めるガイドラインを厳守してください。権利者がガイドラインを定めていない場合や、二次創作を明確に禁止している場合は、制作を行わないでください。</li>
